#include"float4_shader_resource.hpp"

namespace DX12
{
	bool float4_shader_resource::initialize(device* device, unsigned int width, unsigned int height, std::optional<D3D12_CLEAR_VALUE> clearValue)
	{
